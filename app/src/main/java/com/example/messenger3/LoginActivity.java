...
//                        onLoginSuccess();
                        boolean flag=loginCheck(email,password);
                        if (flag){
                            ...
                            Log.d("LoginActivity","Login UnSuccessfull");
                        }
                        // onLoginFailed();
    ...
    private boolean loginCheck(String email, String password) {
        ...
        Cursor cursor = myDbHelper.getData(columns, "email=? or pass=?", new String[]{String.valueOf(email), String.valueOf(password)},tableName);
        cursor.moveToFirst();
